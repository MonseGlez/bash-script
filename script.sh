...
# dpkg -l | grep apache
# if [ $? == 0 ]; then
#     echo "${verde}Apache instalado correctamente"
#     punt1=10
# else
#     echo "${rojo}Apache no está instalado"
#     punt1=0
# fi
# }
# function puerto(){
...
# if [ $? == 0 ]; then
#     echo "${verde}Está corriendo en el puerto 8080"
#     punt2=10
# else
#     echo "${rojo}Apache no está en el puerto 8080"
#     punt2=0
# fi
#return punt2
#}
...
# eleccion($1,$2)
# puntf=$((punt1+punt2))
# touch retroalimentacion.txt
# echo $puntf > retroalimentacion.txt

# echo "${blanco}Tu puntuacion es:"  $puntf
# }
#sudo netstat -tulpn | grep apache | awk '{print $4}' 
sudo netstat -tulpn | grep $2 
    if [ $? == 0 ]; then
        echo "${verde} El $1 corriendo en el puerto $2"
        punt2=10
    else
        echo "${rojo} $1 no está en el puerto $2"
        punt2=0
    fi
